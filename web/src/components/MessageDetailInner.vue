...
<template>
  ...
  <div v-if="!message" class="flex flex-1 flex-col items-center justify-center gap-2.5 p-10 text-center">
      ...
      <div class="px-6 pb-9 pt-5">
        ...
        <div class="mt-6">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <span v-if="!activeTags.length" class="text-xs text-steam-dim/60">暂无{{ L.tag }}</span>
          </div>
